...
| PWA         | `vite-plugin-pwa@1.3.0` + Workbox | FEATURE-014 (2026-07-16) | Vite-integrated hashed precache with prompt-based updates for installable static offline learning; Supabase remains network-only                                          | [ADR-0002](adr/0002-pwa-cache-and-update-strategy.md) |
| E2E         | `@playwright/test@1.61.1`         | FEATURE-014 (2026-07-16) | Production-preview browser coverage for mobile, service worker, offline navigation and deterministic mocked auth/sync                                                     | —                                                     |
