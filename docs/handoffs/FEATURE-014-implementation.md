...
- Candidate commit SHA: recorded after commit (round-9 candidate; supersedes
  `3c46c33`; tree = round-9 validated dirty
  snapshot `e1837f7...` plus this handoff's own evidence update)
...
- Dirty snapshot SHA: `147f779221df87bcdbd2eb7f104d030360cb93f7` (round 9;
  supersedes round-8 `e1837f7...`)
- Validation start (UTC, ISO 8601): `2026-07-17T03:55:16Z`
- Validation completion (UTC, ISO 8601): `2026-07-17T03:57:05Z` (14 canonical
...
- CI commit SHA and status: `PENDING` — no CI run exists for the current
  round-9 uncommitted snapshot
