...
| Implementer R2 (N3–N7, 23 bài vô cơ)   | Codex                                           | GPT-5.6-terra, effort cao                                                                   | Khối lượng lớn nhất trong 3 vòng còn lại, có tính lặp/cơ khí (tuân schema, quy đổi danh pháp) nhưng vẫn cần độ chính xác hoá học cao                              |
...
| Independent Reviewer (mỗi vòng R2–R4)  | Antigravity (agy)                               | Opus 4.6, effort medium                                                                     | Review CRITICAL yêu cầu soát từng dòng thay đổi; execution độc lập, không thấy transcript implementer; đúng quy ước reviewer CRITICAL đã dùng ở các feature trước |
